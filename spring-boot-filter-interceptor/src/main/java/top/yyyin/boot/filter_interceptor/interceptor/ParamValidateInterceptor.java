package top.yyyin.boot.filter_interceptor.interceptor;

import cn.hutool.json.JSONUtil;
import com.fasterxml.jackson.databind.ObjectMapper; // 使用 Jackson 的 ObjectMapper
        ...
        if ("POST".equalsIgnoreCase(request.getMethod()) && "application/json".equals(request.getContentType())) {
            ...
            if (StringUtils.hasText(body)) {
                ...
                if (!violations.isEmpty()) {
                    ...
                    response.getWriter().write(JSONUtil.toJsonStr(Result.error(400, errorMsg)));
                    return false;
                }
            }
        }
